...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'V6 release', link: '/release-notes-v6' },
      { text: 'V7 release', link: '/release-notes-v7' },
    ],
    sidebar: {
      '/api/': [
        {
      ...
      '/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'CanvasKit 7.0.0', link: '/release-notes-v7' },
            { text: 'V7 persistence architecture', link: '/architecture/v7-persistence-recovery' },
            { text: 'V7 release asset manifest', link: '/release-assets-v7' },
            { text: 'V6 editor session architecture', link: '/architecture/v6-editor-session-commands' },
            { text: 'V6 release asset manifest', link: '/release-assets-v6' },
